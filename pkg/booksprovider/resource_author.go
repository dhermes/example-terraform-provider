...
// Populate populates the fields in this structbased on the `terraform`
...
func (ra *ResourceAuthor) Create(ctx context.Context, c booksclient.Client) error {
	...
	a := booksclient.Author{FirstName: ra.FirstName, LastName: ra.LastName}
...
func (ra *ResourceAuthor) Update(ctx context.Context, c booksclient.Client) error {
	...
	a := booksclient.Author{ID: &ra.ID, FirstName: ra.FirstName, LastName: ra.LastName}
